...
function SeriesTracker(series) {
  ...
  this.add = function (serie) {
    ...
    if (serie.isWatched) {} else {// If a serie hasn't been watched:
  ...
  if (series.length > 0) {//Loop through all of the series in the "series" argument
    //Use the .add function to handle adding series, so we keep counts updated.
  }

  this.finishSerie = function () {// find and update currently watching serie in "this.series" array
